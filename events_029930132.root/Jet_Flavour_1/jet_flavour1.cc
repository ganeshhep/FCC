...
void jet_flavour1()
{
  ...
  auto df12 = df11.Define("Flav_Jets", [](std::vector<fastjet::PseudoJet>& PJs) {
			   return applyFlavouredAntiKtAlgorithm(PJs, 0.4);}, {"PJs"});
...
TH1D* hist8 = h8.GetPtr();
  ...
  std::ofstream outFile_1("Flavour_0.4.txt");
  ...
  std::ofstream outFile_2("SDFlavour_0.4.txt");

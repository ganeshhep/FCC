...
void fastjet_fcc1()
{
  ...
  auto rdf1 = df6.Define("Normal_Jets", [](std::vector<fastjet::PseudoJet>& PJs){
  ...
  auto rdf4 = rdf3.Define("Normal_Dijets_M", [](std::vector<fastjet::PseudoJet>& Normal_Jets){
			               return (Normal_Jets[0] + Normal_Jets[1]).m();}, {"Normal_Jets"});
  auto rdf5 = rdf4.Define("Normal_Dijets_Eta", [](std::vector<fastjet::PseudoJet>& Normal_Jets){
			               return (Normal_Jets[0] + Normal_Jets[1]).eta();}, {"Normal_Jets"});
  auto RDF1 = rdf5.Define("Normal_Dijets_Pt", [](std::vector<fastjet::PseudoJet>& Normal_Jets){
  ...
  auto rdf6 = df6.Define("Flav_Jets", [](std::vector<fastjet::PseudoJet>& PJs) {
				   return applyFlavouredAntiKtAlgorithm(PJs, 0.8);}, {"PJs"});
  auto rdf7 = rdf6.Filter("Flav_Jets.size() > 1");
  ...
  auto rdf11 = rdf10.Define("SDFlav_Jets",[](std::vector<fastjet::PseudoJet>& Flav_Jets) {
...
//auto rdf7 = rdf6.Define("N_SDFlav_Jets", "SDFlav_Jets.size()");
  ...
  auto h5 = RDF2.Histo1D({"pT", "SDFlav_Dijet", 400u, 0., 400.}, "Flav_Dijets_Pt");
  auto h6 = RDF2.Histo1D({"M", "SDFlav_Dijet", 800u, 0., 800.}, "Flav_Dijets_M");
